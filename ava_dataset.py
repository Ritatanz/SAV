...
class AVADataset(BaseActionDataset):
    ...
    def __init__(self,
                 ...
                 filename_tmpl: str = None,  #'img_{:05}.jpg'
                 start_index: int = 1,
                 proposal_file: str = None,
                 person_det_score_thr: float = None,  #0.9 for ava,  0.8 for sav
                 num_classes: int = None,  #81 16
                 custom_classes: Optional[List[int]] = None,
                 data_prefix: ConfigType = dict(img=''),
                 modality: str = 'RGB',
                 test_mode: bool = False,
                 num_max_proposals: int = 1000,
                 timestamp_start: int = None, #900  0
                 timestamp_end: int = None,  #1800  3
    ...
    def get_data_info(self, idx: int) -> dict:
        ...
        # tanzl
        # key_base = img_key.split(',')[0]  # for ava
        # 设置文件名模板
        # self.filename_tmpl = f"{key_base}_{{:06d}}.jpg"  # for ava
        ##########
