...
from mmaction.datasets import AVADataset, AVAKineticsDataset, SAVDataset
...
class TestAVADataset:
    ...
    def test_ava_pipeline(self):
        ...
        # assert result['filename_tmpl'] == 'img_{:05}.jpg' #ava
        # assert result['filename_tmpl'] == 'img_{:06}.jpg' #sav
        assert result['modality'] == 'RGB'
        assert result['start_index'] == 1
        # assert result['timestamp_start'] == 900 #sav:0  ava:900
        # assert result['timestamp_end'] == 1800  #sav:180  ava:1800
        ...
        assert result['filename_tmpl'] == 'img_{:05}.jpg' #classroom
        assert result['modality'] == 'RGB'
        assert result['start_index'] == 1
        assert result['timestamp_start'] == 900 #ava900  classroom0
        assert result['timestamp_end'] == 1800 #ava1800  classroom3
